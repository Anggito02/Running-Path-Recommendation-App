...
public class PathFrame
{
    ...
    // Labels
    private static JLabel headerTitle = new JLabel("Runner Path");

    // Path Panel
    private static JPanel pathPanel = new JPanel();
    // Labels INIT
    private static JLabel startLabel = new JLabel("START");
    private static JLabel finishLabel = new JLabel("END");
    private static JLabel distLabel = new JLabel("Distance");
    private static JLabel pathLabel = new JLabel("Path");
    private static JLabel end = new JLabel("<html><div style='text-align: center;'>" + "Run Everyday Keeps<br>The Doctor Away" + "</div></html>");
    // Labels ANS
    private static JLabel ansStartLabel = new JLabel("");
    private static JLabel ansFinishLabel = new JLabel("");
    private static JLabel ansDistLabel = new JLabel("");
    private static JTextArea ansPathLabel = new JTextArea("");
    private static JScrollPane scroll;

    /* ===== UTILITY ===== */
    private static Font f1 = new Font("Verdana", Font.ITALIC + Font.BOLD, 32);     // title
    private static Font f2 = new Font(Font.SERIF, Font.PLAIN, 12);          // path
    private static Font f3 = new Font("Helvetica", Font.PLAIN, 16);        // end
    private static Font f4 = new Font(Font.SERIF, Font.PLAIN, 16);         // menus
    private static Font f5 = new Font(Font.SERIF, Font.PLAIN, 14);         // ans
 
    private static Color c1 = new Color(245, 163, 0);      // yellow
    private static Color c3 = new Color(255, 204, 0);
    private static Color c2 = new Color(46, 44, 40);       // brown
    /* ===== END OF UTILITY ===== */
    ...
    private static void initComponents() {
        ...
        scroll = new JScrollPane(ansPathLabel);
    ...
    private static void printSolution(int src, int distances[], int parents[], int dest, Vector<crossRoadNode> roadList) {
        ...
        ansDistLabel.setText(": " + Integer.toString(distances[dest]));
        //initComponents();
